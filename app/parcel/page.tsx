  ...
  return (
    <main className="py-8 space-y-8">
      <section className="space-y-4">
        <Logo className="w-32 h-auto text-zinc-900 dark:text-zinc-100" />
        <div className="space-y-2">
          ...
          <a
            ...
            className="my-4 inline-flex items-center gap-2 rounded-lg bg-zinc-900 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-zinc-700 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-300"
          >
      ...
      <section className="space-y-2 pb-4">
        <h2 className="text-lg font-medium text-zinc-900 dark:text-zinc-100">Why Parcel?</h2>
        <div className="space-y-4 text-zinc-600 dark:text-zinc-400">
          <ul className="space-y-2 list-disc pl-5">
            <li><strong className="font-medium text-zinc-900 dark:text-zinc-100">Truly Private:</strong> Everything is locked on your device before it ever reaches the cloud. Nobody can see your saved links or notes.</li>
            <li><strong className="font-medium text-zinc-900 dark:text-zinc-100">Share Securely:</strong> Send bundles of links and secrets to others safely. Only the person with your shared link and key can unlock them.</li>
            <li><strong className="font-medium text-zinc-900 dark:text-zinc-100">Everywhere you go:</strong> Save effortlessly as you browse with the companion browser extension.</li>
          </ul>
        </div>
      </section>
