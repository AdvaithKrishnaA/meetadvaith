      ...
      >
        ...
        >
          <img
            src={image}
            alt={`${name} preview`}
            className="aspect-video w-full cursor-zoom-in rounded-xl object-cover grayscale transition-all duration-300 md:group-hover:grayscale-0 md:group-focus-visible:grayscale-0"
          />
        </MorphingDialogTrigger>
        <MorphingDialogContainer>
      ...
      >
        ...
        >
          <video
            ...
            loop
            muted
            className="aspect-video w-full cursor-zoom-in rounded-xl grayscale transition-all duration-300 md:group-hover:grayscale-0 md:group-focus-visible:grayscale-0"
          />
        </MorphingDialogTrigger>
        <MorphingDialogContainer>
          <MorphingDialogContent className="relative max-w-4xl">
