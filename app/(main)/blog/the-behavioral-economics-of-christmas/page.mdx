export const metadata = {
  ...
  description: 'From gift waste to secret-santas to sale-induced overspending.',
  alternates: {
    canonical: '/blog/the-behavioral-economics-of-christmas'
  }
}
...
<Cover
  src="/behavioral-economics-of-christmas.svg"
