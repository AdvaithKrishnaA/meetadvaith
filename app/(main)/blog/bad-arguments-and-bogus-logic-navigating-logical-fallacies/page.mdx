export const metadata = {
  ...
  description:
    'A practical walkthrough of common logical fallacies—straw man, begging the question, slippery slope, false cause, and appeal to popularity—and how to spot them.',
  alternates: {
    canonical: '/blog/bad-arguments-and-bogus-logic-navigating-logical-fallacies',
  },
};
...
<Cover
  src="/bad-arguments-and-bogus-logic-navigating-logical-fallacies.webp"
