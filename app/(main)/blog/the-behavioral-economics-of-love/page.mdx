export const metadata = {
  ...
  description: 'We dive into the behavioral economics of relationships (and love). Spoiler: our choices in love aren\'t always rational!',
  alternates: {
    canonical: '/blog/the-behavioral-economics-of-love'
  }
}
...
<Cover
  src="/behavioral-economics-of-love.webp"
