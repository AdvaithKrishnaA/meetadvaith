...
function MorphingDialogTitle({
  ...
  const inContent = useContext(MorphingDialogInContentContext)
  ...
  return (
    <MotionComponent
      ...
      style={style}
      layout
      id={inContent ? `motion-ui-morphing-dialog-title-${uniqueId}` : undefined}
    >
      {children}
    </MotionComponent>
  )
...
function MorphingDialogDescription({
  ...
  return (
    <MotionComponent
      ...
      animate="animate"
      exit="exit"
      id={inContent ? `motion-ui-morphing-dialog-description-${uniqueId}` : undefined}
    >
      {children}
    </MotionComponent>
  )
